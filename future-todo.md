...
- R-08 release candidate 기록: `codex/r08-service-master`는 `a7a4186` base의 Draft PR #16이며 migration 10번째 후보·schema/UI/Pencil/test의 local fresh/upgrade/rollback/build/mobile/PWA 검증을 완료했습니다. main 통합, live migration·배포·실사용자 smoke는 아직 완료하지 않음
