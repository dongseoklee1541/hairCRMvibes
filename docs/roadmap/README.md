...
- R-09는 PR #20 merge, exact 11번째 live migration과 Production 공개/PWA smoke까지 완료했습니다. R-10은 Draft PR #26에서 merge-blocked 상태로 검증 중이며 R-11은 별도 작업으로 유지합니다.
...
| R-10 | [R-10-role-management.md](./R-10-role-management.md) | In Progress (Draft PR #26; checks pass; merge-blocked) |
...
R-10은 `origin/main@b225884`에서 구현한 뒤 최신 `origin/main@ec8bff1`을 통합하고 Draft PR #26을 열었습니다. Vercel checks는 통과했고 migration diff는 R-10 local-only 1개이며 Production/Preview에는 R-10 table/RPC가 없습니다. 실제 Auth 사용자·초대·역할은 변경하지 않았습니다. invitation request ledger 부재와 canonical Supabase Auth redirect 미등록은 merge/release blocker입니다.
