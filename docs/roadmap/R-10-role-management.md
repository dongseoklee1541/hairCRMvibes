...
- 다음 행동: 로컬 준비·검증한 ACL migration의 적용 범위 승인·원격 검증 → 승인된 합성 owner 검증. 완료된 Auth URL 적용은 반복하지 않습니다. 실제 초대·계정·역할 변경과 flag 활성화는 승인된 대상/환경에 한정합니다. [운영 runbook](../operations/r10-invitation-ledger.md)을 따릅니다.
