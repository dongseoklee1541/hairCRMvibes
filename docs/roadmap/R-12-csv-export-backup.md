...
## 상태
- Verified (dedicated Preview integration; branch deployment pending)
...
- 완전한 운영 백업이 목적이므로 CSV에는 고객 연락처·메모와 예약 메모가 포함됩니다. 화면에서 이를 경고하고 접근이 제한된 위치에 보관하도록 요구합니다.
...
- 실제 Next production server에서 anonymous 요청은 `401 AUTH_REQUIRED`, 비허용 dataset은 `400 INVALID_DATASET`이며 두 응답 모두 `no-store`, JSON, `nosniff`, same-origin CORP를 확인했습니다.
- synthetic owner session과 mock Supabase만 사용해 390×844와 360×800에서 다음을 검증했습니다.
  - 확인 전 두 버튼 disabled, 확인 후 enabled
  - native checkbox의 keyboard Space 조작과 focus ring
  - 고객 CSV 다운로드 filename과 Bearer token 전달
  - 예약 CSV 오류 문구, 성공 상태 안내
  - CTA 56px, 확인 영역 56px, warning 54px 이상, horizontal overflow 0
  - 정상 상태 console warning/error와 page error 0건
- production-mode PWA에서 service worker active/controller를 확인했습니다. 오프라인 `/api/export` 요청은 NetworkOnly로 실패했고 `/api/export`, CSV, Supabase 응답의 Cache Storage 항목은 0건이며 온라인 복구 후 `/settings`와 console이 정상입니다.
...
- after 390×844: `/Users/idongseog/.codex/visualizations/2026/07/13/019f59d5-495d-7680-8dec-3af3a123585c/r12/20260713_settings_r12_after_390x844.png`
- after 360×800: `/Users/idongseog/.codex/visualizations/2026/07/13/019f59d5-495d-7680-8dec-3af3a123585c/r12/20260713_settings_r12_after_360x800.png`
- success/error 390×844: `/Users/idongseog/.codex/visualizations/2026/07/13/019f59d5-495d-7680-8dec-3af3a123585c/r12/20260713_settings_r12_success_error_390x844.png`
- checked 360×800: `/Users/idongseog/.codex/visualizations/2026/07/13/019f59d5-495d-7680-8dec-3af3a123585c/r12/20260713_settings_r12_checked_360x800.png`
...
- Vercel branch Preview 배포와 실제 로그인 390×844·360×800/PWA 검증, synthetic fixture 잔존 0 확인은 push 뒤 완료합니다.
